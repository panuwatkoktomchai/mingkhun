...
<form class="form-horizontal" action="<?php if(isset($_SESSION['id'])){echo "update-users.php?p=profile-teacher.php";}else{echo "insert-user.php?p=add-users.php";}?>" method="post" >        
