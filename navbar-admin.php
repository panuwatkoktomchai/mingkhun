    ...
    <nav class="navbar-inverse bs-dark">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          <ul class="nav navbar-nav">
            <li><a href="add-users.php">เพิ่ม / จัดการสมาชิก<span class="sr-only"></span></a></li>
          ...
          <ul class="nav navbar-nav navbar-right">
            <li class="dropdown">
              ...
              &nbsp;<?php  echo $_SESSION['fullname'];?>  (เจ้าของร้าน)
              ...
              <ul class="dropdown-menu">
                ...
                <li><a href="profile-admin.php">จัดการข้อมูลส่วนตัว &nbsp;<span class="glyphicon glyphicon glyphicon-edit"></a></a></li>
