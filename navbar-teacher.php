    ...
    <nav class="navbar-inverse bs-dark">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          <ul class="nav navbar-nav">
            <li><a href="add-music-course.php">จัดตารางสอน<span class="sr-only"></span></a></li>
            <li><a href="#">บันทึกการเข้าเรียน<span class="sr-only"></span></a></li>

          </ul>
          <ul class="nav navbar-nav navbar-right">
            <li class="dropdown">
              <a href="teacher.php" class="dropdown-toggle navbar-img" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
              &nbsp; <?php  echo $_SESSION['fullname']; ?> (อาจารย์)
              ...
              <ul class="dropdown-menu">
                ...
                <li><a href="profile-teacher.php">จัดการข้อมูลส่วนตัว &nbsp;<span class="glyphicon glyphicon glyphicon-edit"></a></a></li>
