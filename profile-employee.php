...
<form class="form-horizontal" action="<?php if(isset($_SESSION['id'])){echo "update-users.php?p=profile-employee.php";}else{echo "insert-user.php?p=add-users.php";}?>" method="post" >        
        ...
        <div class="form-group">
          ...
          <div class="col-md-5 col-sm-8">
            ...
            <input required type="text" class="form-control" name="tel" value="<?php echo $user['tel']; ?>" placeholder="Tel" maxlength="10">
            </div>
          </div>
        </div>
